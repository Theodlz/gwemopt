...
def parse_commandline():
    ...
    parser.add_option(
        "-s", "--skymap", help="GW skymap.", default="../output/skymaps/G268556.fits"
    )
    parser.add_option(
    ...
    parser.add_option("--transientsFile", default="../data/GW190425/transients.dat")
    parser.add_option("--transients_to_catalog", type=float, default=0.8)
...
if opts.doTransients:
    ...
    if opts.doCatalog:
        catalog_struct = gwemopt.transients.combine_catalog_transients(
            params, catalog_struct, transients_struct
        )
    else:
        catalog_struct = transients_struct
...
if opts.doSchedule or opts.doCoverage:
    ...
    if opts.doCatalog or opts.doTransients:
